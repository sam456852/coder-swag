...
class DataService {
    ...
    private let shirts = [
        ...
        Product(title: "Devslope Logo Shirt Light Grey", price: "$18", imageName: "shirt02.png"),
        Product(title: "Devslope Logo Shirt Red", price: "$18", imageName: "shirt03.png"),
        Product(title: "Devslope Logo Shirt Grey", price: "$18", imageName: "shirt04.png"),
